...
async def get_hotel_details(
    ...
    Exemple: /hotel_details?hotel_id=moder-flat-heart-of-iveme&checkin=2025-12-12&checkout=2025-12-15&adults=2
    """
    try:
        ...
        async with DetailsScraper() as scraper:
            result = await scraper.get_hotel_details(request)
            return result
